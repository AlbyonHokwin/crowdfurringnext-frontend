...
export default function LoginScreen({ navigation }) {
    ...
    const handleConnection = () => {
        ...
        if (!EMAIL_REGEX.test(email)) { setEmailError(true); signinOk = false }
        if (!signInPassword.trim()) { setPasswordError(true); signinOk = false }
    ...
    return (
        <View style={styles.container}>
            <View style={styles.signUpContainer}>
                <Text style={styles.text}>Nouvel utilisateur ? Créez votre compte !</Text>
            ...
            <View style={styles.loginContainer}>
                <Text style={styles.text}>Vous avez déjà un compte ? Connectez-vous !</Text>
                <TextInput
